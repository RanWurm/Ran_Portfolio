...
const links = [
	...
	{url: "https://drive.google.com/uc?export=download&id=1rCifYGJYy3vgJERmEDPnxJy6Mt7xLNTO", title:"CV"},	
    ...
    return(
        <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl ">
			...
			<div className="hidden md:flex gap-4  w-1/3">
				...
				<Link href ="https://drive.google.com/uc?export=download&id=1rCifYGJYy3vgJERmEDPnxJy6Mt7xLNTO" >
